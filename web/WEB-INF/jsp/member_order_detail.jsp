...
<%@ page import="com.we.pojo.SessionOrder" %>
            ...
            <span>订单详情</span>
                    ...
                    <div class="member_cort">
                        ...
                        <%
                            ...
                            SessionOrder order = orders.get(index);
                        ...
                        <div class="member_cort-right fr">
                            ...
                            <div class="member_myorder-xq">
                                ...
                                <ul class="member_myorder-xq-tittle">
                                    <li>
                                        <i>您的订单号：${order.random}</i>
                                    </li>
                                    <li>
                                        <i>订单状态： </i>
                                        <a href="#">${order.state}</a>
                                    </li>
                                    <li>
                                        <i>下单时间：</i>
                                ...
                                <div class="member_myorder-xq-news">
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" class="myorder-xq-news_table" style="font-family:微软雅黑">
                                        <tbody><tr>
                                            ...
                                            <td class="news_table-td2">${order.state}</td>
                                            <td class="news_table-td1">预计到货日期</td>
                                            <td class="news_table-td3">${order.et}</td>
                                        </tr>
                                        <tr>
                                            <td class="news_table-td1">订单总金额</td>
                                            <td class="news_table-td2">￥${order.total}</td>
                                            <td class="news_table-td1">物流方式</td>
                                            <td class="news_table-td3">${order.logisistics}</td>
                                        </tr>
                                        <tr>
                                            <td class="news_table-td1">收货人</td>
                                            <td class="news_table-td2">${order.shipping.sname}</td>
                                            <td class="news_table-td1">邮政编码</td>
                                            <td class="news_table-td3">${order.shipping.scoding}</td>
                                        </tr>
                                        <tr>
                                            <td class="news_table-td1">移动电话</td>
                                            <td class="news_table-td2">${order.shipping.sphone}</td>
                                            <td class="news_table-td1">联系电话</td>
                                            <td class="news_table-td3">${order.shipping.telephone}</td>
                                        </tr>
                                        <tr>
                                            <td class="news_table-td1">E-Mail</td>
                                            <td class="news_table-td2"></td>
                                            <td class="news_table-td1">收货人地址</td>
                                            <td class="news_table-td3">${order.shipping.province}${order.shipping.city}${order.shipping.district}${order.shipping.street}</td>
                                        </tr>
                                        <tr>
                                            <td class="news_table-td1">备注</td>
                                            <td colspan="3" class="news_table-td4">${order.remark}</td>
                                        </tr>
                                        </tbody></table>
                                    <!--订单信息的table end-->
                                    <div class="myorder-xq-news_top">
                                        ...
                                        <c:forEach items="${order.carts}" var="cart">
                                            ...
                                            <td class="xq-shop_table-td1">
                                                <a href="/darry_ring/87.html">
                                                    <img width="55" height="55" class="fl" src="images/${cart.commdity.image.filename}">
                                                    <span class="fl">
                                            ${cart.commdity.seres}系列 ${cart.commdity.style}
                                            </span></a>
                                            </td>
                                            <td class="xq-shop_table-td2">
                                                <p>${cart.commdity.minute}分 ${cart.commdity.colour}</p><p></p><p></p>
                                            </td>
                                            <td class="xq-shop_table-td3">${cart.commdity.texture}</td>
                                            <td class="xq-shop_table-td4">
                                                <p>${cart.chicun}</p>
                                            </td>
                                            <td class="xq-shop_table-td5">${cart.kezi}</td>
                                            <td style="font-family:微软雅黑" class="xq-shop_table-td6">￥${cart.commdity.price}</td>
                                        </tr>
                                        </c:forEach>
                                        </tbody></table>
                                    <!--商品明细end-->
                                    ...
                                    <div class="member_myorder-xq-retrun">
                                        <a class="fr" href="member_order">> 返回订单列表</a>
                                    </div>
                                    <!--返回订单end-->
                                </div>
                                <!--我的订单详情end-->

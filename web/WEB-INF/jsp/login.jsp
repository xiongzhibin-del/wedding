    ...
    <div class="container">
        ...
        <div class="cmain ddd">
            ...
            <div class="cort-right right">
                <div class="r_bg"></div>
                <!--登陆框内-->
                <form method="post" action="user/loginUser" id="loginform" >
                    <div class="cr_border">
                        <h3></h3>
                        <!--邮箱-->
                        <div id="cssName" class="the_input ">
                            ...
                            <input type="text" placeholder="请输入用户名/手机/邮箱" id="txtName" class="al_Input dr_email" value="" name="uname" onblur="checkTeaMess()" id="signin-mess" />
                            <i id="tname"></i>
                        </div>
                        <!--邮箱end-->
                        <!--密码-->
                        <div style="margin-top:15px;" class="the_input" id="cssPwd">
                            ...
                            <input type="password" placeholder="请输入密码" id="txtPwd" class="al_Input" value="" name="upassword" onblur="checkPassword()" id="signin-password" />
                            <i id="pwdd"></i>
                        </div>
                        <!--验证码-->
                        <!--验证码end-->
...
<%--                                <input name="" type="submit" class="left" value="登录"  onclick="javascript:window.location='index.html'"  />--%>
                            </div>
                        </div>
                        <!--按钮end-->
                        <!--其他合作-->
...
<script type="text/javascript" language="JavaScript">
  //   function checkForm(){
  //       var uname=checkTeaMess();
  //       var upassword=checkPassword();
  //       return uname &&upassword;
  //   }
  //   function checkPassword(){
  // var upassword=$("#signin-password").val();
  //       var errorMess=$("#error-message");
  //       if(upassword.length==0){
  //           reeorMess.innerHTML="用户名不能为空"
  //       }
  //       return true;
  //   }
  //   function checkTeaMess(){
  //        var regPhone=/^1[34578]\d{9}$/;/* 手机号验证，11位手机号 */
  //       var regName=/^\w{3,}$/;/*用户名验证，至少三位 */
  //       var regEmai=/^\w+@\w+\.[A-Za-z]{2,3}(\.[A-Za-z]{2,3})?$/;
  //       //获取用户登录信息
  //       var uname=$("#signin-mess").val();
  //       var upassword=$("#signin-password").val();//获取输入的登录密码
  //       var errorMess=$("#error-message");
  //       //判断用户是否是邮件登录,是则将name属性值从uanem改为e——mail
  //       if(regEmai.test(uname)){
  //           $("#signin-mess").attr("name","e_mail")
  //       }
  //       //判断用户是否是手机登录,是则将name属性值从uanem改为phone
  //       if(regEmai.test(uname)){

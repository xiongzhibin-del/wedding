                ...
                <li><a style="font-family:arial" href="lists.html">Darry Ring 求婚钻戒</a>
                    <div class="nav-div">
                        <div class="navdiv_top">
                            ...
                            <div class="navdiv-left">
                                <h3> NEW</h3>
                                <a href="detail.html"> <img width="138" height="97" alt="2克拉钻戒价格_E色EX切工VVS2净度_True Love系列 奢华款 _Darry Ring求婚钻戒 戴瑞珠宝官网" src="images/03wj.jpg" /></a>
                                <div class="more_cp">
        ...
        <div class="all-thing">
            ...
            <div class="cmain">
                ...
                <ul class="news-ul">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="/shopyd"> <img width="235" height="130" alt="Darry Ring实体店" src="images/tyzx.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="brand.html"> <img width="235" height="130" alt="关于Darry Ring" src="images/zajz.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="brand.html_mr"> <img width="235" height="130" alt="社会名人倾情推荐" src="images/famous.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                    ...
                    <li>
                        <div class="ul-top">
                            <a target="_blank" href="lists.html"> <img width="235" height="130" alt="网络热门钻戒品牌" src="images/wlzj.jpg" /> </a>
                        </div>
                        <div class="ul-center">
                ...
                <ul class="all_tab">
                    <li style="display: none;">
                        ...
                        <div class="tab_left fl">
                            <a href="index.html/dr_series/12_22.html"> <img width="504" height="314" alt="Forever经典系列" src="images/fimg6.jpg" /> </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        <!--tab选项卡下的右边内容-->
                    ...
                    <li style="display: none;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/pinkdiamond.aspx"> <img width="504" height="314" alt="Marry Me系列" src="images/fimg1.jpg" /> </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        <!--tab选项卡下的右边内容-->
                        <div class="tab_right fr">
                    ...
                    <li style="display: list-item; opacity: 0.470565;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/dr_series/16_30.html"> <img width="515" height="314" alt="True Love系列" src="images/fimg3.jpg" /> </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        <!--tab选项卡下的右边内容-->
                        <div class="tab_right fr">
                    ...
                    <li style="opacity: 0.529435; display: list-item;">
                        <!--tab选项卡下的左边内容-->
                        <div class="tab_left fl">
                            <a href="/dr_series/15_18.html"> <img width="504" height="314" alt="I Swear系列" src="images/fimg4.jpg" /> </a>
                        </div>
                        <!--tab选项卡下的左边内容 end-->
                        <!--tab选项卡下的右边内容-->
                        <div class="tab_right fr">
                    ...
                    <ul id="ullist" class="buyit">
                        <li>
                            <div class="by_top">
                                ...
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;50分&nbsp;H色" src="images/2014090119350717386d7a1e.jpg" />
                                </div>
                        ...
                        <li>
                            <div class="by_top">
                                <a target="_blank" href="detail.html" rel="nofollow"></a>
                                <div style="opacity:1" class="bything-one">
                                    <img width="236px" height="236px" alt="Forever系列 经典款&nbsp;40分&nbsp;D色" src="images/201409011932585de1c2f2a9.jpg" />
                                </div>
                                <div style="opacity:0" class="bything-two">
                                    <img width="236px" height="236px" src="images/20140901193258beafcb5eb7.jpg" />
                                </div>
                            </div>
                            <div class="by_center"></div>
                            <div class="by_bottom">
